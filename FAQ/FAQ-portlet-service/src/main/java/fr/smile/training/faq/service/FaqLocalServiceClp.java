 ...
 * @generated
 */
public class FaqLocalServiceClp implements FaqLocalService {
    ...
    public FaqLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fr.smile.training.faq.model.Faq addFaq(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(faq) });
        } catch (Throwable t) {
        ...
        return (fr.smile.training.faq.model.Faq) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fr.smile.training.faq.model.Faq> getFaqs(int start,
        ...
        return (java.util.List<fr.smile.training.faq.model.Faq>) ClpSerializer.translateOutput(returnObj);
    }
