...
public class RestaurantWrapper implements Restaurant, ModelWrapper<Restaurant> {
    ...
    */
    ...
    @Override
    public int compareTo(com.smile.plugins.model.Restaurant restaurant) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.smile.plugins.model.Restaurant> toCacheModel() {
        return _restaurant.toCacheModel();
    }

    @Override
    public com.smile.plugins.model.Restaurant toEscapedModel() {
        return new RestaurantWrapper(_restaurant.toEscapedModel());
    }

    @Override
    public com.smile.plugins.model.Restaurant toUnescapedModel() {
