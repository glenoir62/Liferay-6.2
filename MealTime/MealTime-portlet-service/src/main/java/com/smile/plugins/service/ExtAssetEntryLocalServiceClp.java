 ...
 * @generated
 */
public class ExtAssetEntryLocalServiceClp implements ExtAssetEntryLocalService {
    ...
    public ExtAssetEntryLocalServiceClp(
        ...
        _methodName3 = "getJournalArticleByGroupIdCategories";

        _methodParameterTypes3 = new String[] {
                "int", "int", "long[][]", "long[][]", "long"
            };

        _methodName4 = "getJournalArticleCountByGroupIdCategories";
    ...
    public java.util.List<com.liferay.portlet.asset.model.AssetEntry> getJournalArticleByGroupIdCategories(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName3,
                    ...
                    ClpSerializer.translateInput(categoryTypeIdsList),
